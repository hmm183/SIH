          ...
          <motion.div key="login" variants={cardVariants} initial="hidden" animate="visible" exit="exit" className="space-y-6">
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
                    <input name="email" type="email" placeholder={t('emailAddress')} value={formData.email} onChange={handleChange} required className="w-full pl-4 p-2 border rounded-md dark:bg-gray-900 dark:border-gray-600 dark:text-white" />
                </motion.div>
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
                    <input name="password" type="password" placeholder={t('password')} value={formData.password} onChange={handleChange} required className="w-full pl-4 p-2 border rounded-md dark:bg-gray-900 dark:border-gray-600 dark:text-white" />
                </motion.div>
                <motion.button
                    type="submit"
                    disabled={loading}
          ...
          <motion.div key="verify" variants={cardVariants} initial="hidden" animate="visible" exit="exit" className="space-y-6">
            ...
            <form className="space-y-4" onSubmit={handleVerify}>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="relative">
                ...
                <input name="doctorId" type="text" placeholder={t('nmcDoctorId')} value={formData.doctorId} onChange={handleChange} required className="w-full pl-10 p-2 border rounded-md dark:bg-gray-900 dark:border-gray-600 dark:text-white" />
              </motion.div>
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="relative">
                ...
                <input name="licenseNumber" type="text" placeholder={t('registrationNumber')} value={formData.licenseNumber} onChange={handleChange} required className="w-full pl-10 p-2 border rounded-md dark:bg-gray-900 dark:border-gray-600 dark:text-white" />
              </motion.div>
              <motion.button
                  type="submit"
                  disabled={loading}
